...
function buildLoader() {
  return {
    ...
    output: [
      ...
      {
        file: `../onekey-mvp-demo-express/public/assets/cmp/ok-ui.js`,
        sourcemap: true,
        format: 'iife'
      },
      {
        file: `../onekey-mvp-demo-express/public/assets/cmp/ok-ui.min.js`,
        format: 'iife',
        sourcemap: true,
        plugins: [terser(terserOptions)]
      },
...
function buildLocaleConfig(localeCode, localeContent, tcfCoreTemplate) {
  return {
    ...
    external: [ path.resolve( '../onekey-mvp-frontend/src/lib/paf-lib.ts' ) ],
    plugins: [
      replace({
        include: './src/main.ts',
        preventAssignment: true,
    ...
    output: [
      ...
      {
        file: `../onekey-mvp-demo-express/public/assets/cmp/ok-ui-${localeCode}.js`,
        sourcemap: true,
        format: 'iife',
      },
      {
        file: `../onekey-mvp-demo-express/public/assets/cmp/ok-ui-${localeCode}.min.js`,
        format: 'iife',
        sourcemap: true,
        plugins: [terser(terserOptions)]
      },
