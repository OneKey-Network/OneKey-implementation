(function () {
  ...
  var data$1 = { auditHeading:"Your ad-funded access (US)",
    auditBody:[ "The following OneKey participating providers funded your access to this site's content. These organizations do not directly identify you, but rely instead on your OneKey ID and preferences for this purpose. Your OneKey ID will automatically reset every 6 months or you can reset your ID or preference at any time by clicking&nbsp;<a href=\"[Settings]\">here</a>." ],
   ...
   */
  class FieldTransmissionResult extends FieldReadOnly {
  }
  /**
      ...
      <section class="ok-ui-card">
        <header class="ok-ui-card__header">
          <div class="ok-ui-card__actions">
            <img src="images/OneKey.svg" alt="OneKey" class="ok-ui-card__header-logo">
          </div>
...
<button type="button" class="ok-ui-button ok-ui-button--text ok-ui-button--small ok-ui-button--icon-only ok-ui-button--icon-start">
  ...
  var iconCross = "<svg width=\"1.5em\" height=\"1.5em\" viewBox=\"0 0 18 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\r\n    <path d=\"M9 17.3333C5.62796 17.3353 2.58708 15.3049 1.29638 12.1896C0.00569443 9.07439 0.719616 5.48834 3.105 3.10494C5.21108 0.998862 8.28076 0.176344 11.1577 0.947223C14.0347 1.7181 16.2818 3.96526 17.0527 6.84222C17.8236 9.71918 17.0011 12.7889 14.895 14.8949C13.3345 16.4625 11.2118 17.3405 9 17.3333ZM2.33333 9.14328C2.37276 12.811 5.36759 15.7579 9.03544 15.7383C12.7033 15.7185 15.6663 12.7395 15.6663 9.07161C15.6663 5.4037 12.7033 2.42475 9.03544 2.40494C5.36759 2.38532 2.37276 5.33224 2.33333 8.99994V9.14328ZM6.84083 12.3333L5.66666 11.1583L7.825 8.99994L5.66666 6.84161L6.84166 5.66661L9 7.82494L11.1583 5.66661L12.3333 6.84161L10.175 8.99994L12.3333 11.1583L11.1592 12.3333L9 10.1749L6.84166 12.3333H6.84083Z\" fill=\"#F03F3F\" />\r\n</svg>";
  ...
  class Controller {
      ...
      constructor(locale, element) {
          ...
          const auditLog = JSON.parse(element.getAttribute('data-audit-log'));
