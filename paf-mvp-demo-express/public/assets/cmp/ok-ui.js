(function () {
  ...
  data$1.aboutHeading;
  data$1.aboutBody;
  data$1.settingsHeading;
  data$1.settingsBody;
  data$1.settingsBrowsingId;
  data$1.settingsBrowsingIdTip;
  data$1.settingsPersonalizedLabel;
  data$1.settingsPersonalizedBody;
  data$1.settingsStandardLabel;
  data$1.settingsStandardBody;
  data$1.settingsThisSite;
  data$1.customizeCurrent;
  data$1.customizeAll;
  data$1.customizeStandard;
  data$1.customizePersonalized;
  data$1.customizeCustomized;
  data$1.customizeLabels;
  data$1.customizeTips;
  data$1.snackbarHeadingPersonalized;
  data$1.snackbarHeadingStandard;
  data$1.snackbarHeadingCustomized;
  data$1.snackbarBodyPersonalized;
  data$1.snackbarBodyStandard;
  data$1.snackbarBodyCustomized;
  data$1.refuseAll;
  data$1.proceed;
  data$1.save;
  data$1.customize;
