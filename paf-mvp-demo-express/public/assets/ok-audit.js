    ...
    <form>
      <section class="ok-ui-card">
        <header class="ok-ui-card__header">
          <div class="ok-ui-card__actions ok-ui-card__header-logo">
            ${ _.Logo }
          </div>
...
<button type="button" class="ok-ui-button ok-ui-button--text ok-ui-button--small ok-ui-button--icon-only ok-ui-button--icon-start">
  ...
  class Controller {
       ...
       */
      constructor(locale, element, okUiCtrl) {
          if (locale === null) {
              throw 'Locale needed';
          }
          if (element === null) {
  ...
  if (element !== null) {
      ...
      new Controller(new Locale(window.navigator.languages), element, window.PAFUI.okUiCtrl);
  }
