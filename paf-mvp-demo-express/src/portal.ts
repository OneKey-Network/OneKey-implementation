...
const verifiers: { [name in keyof Model]?: Verifier<unknown> } = {
    ...
    ['redirect-get-ids-prefs-request']: new Verifier(keyStore.provider, new RedirectRequestDefinition<GetIdsPrefsRequest>(new MessageWithoutBodyDefinition())),
    ['redirect-get-ids-prefs-response']: new Verifier(keyStore.provider, new RedirectResponseDefinition<GetIdsPrefsResponse>(new MessageWithBodyDefinition())),
    ['redirect-post-ids-prefs-request']: new Verifier(keyStore.provider, new RedirectRequestDefinition<PostIdsPrefsRequest, UnsignedMessage<PostIdsPrefsRequest>>(new MessageWithBodyDefinition())),
    ['redirect-post-ids-prefs-response']: new Verifier(keyStore.provider, new RedirectResponseDefinition<PostIdsPrefsResponse, UnsignedMessage<PostIdsPrefsResponse>>(new MessageWithBodyDefinition())),
};
