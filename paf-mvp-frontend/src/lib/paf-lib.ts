...
export interface TransmissionRegisteryContext {
 ...
 */
export const generateSeed = async (options: GenerateSeedOptions, pafTransactionIds: TransactionId[]): Promise<Seed | undefined> => {
...
export const registerTransmissionResponse = (
  { prebidTransactionId, pafTransactionId, slotId, contentId }: TransmissionRegisteryContext,
